...
@SessionScoped
public class ClienteController extends Control implements Serializable {

    @Inject
    private ClienteFachadaLocal ejbFacade;
    ...
    private ClienteFachadaLocal getFacade() {
        return ejbFacade;
    }
    ...
    public void createCliente() {
        ...
        try {
            ...
            facturarController.consultarClientes();
            facturarController.setCliente( getSelected());
        } catch (Exception e) {
