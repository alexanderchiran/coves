...
import com.gestion.coves.services.TipoIdentificacionService;
...
public class TipoIdentificacionController implements Serializable {
    ...
    @Inject
    private com.gestion.coves.services.TipoIdentificacionService ejbFacade;
    ...
    private TipoIdentificacionService getFacade() {
        return ejbFacade;
    }
