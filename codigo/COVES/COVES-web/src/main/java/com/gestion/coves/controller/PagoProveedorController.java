...
import com.gestion.coves.fachada.PagoProveedorFachadaLocal;
...
@Named("pagoProveedorController")
@SessionScoped
public class PagoProveedorController extends Control implements Serializable {

    @Inject
    private PagoProveedorFachadaLocal ejbFacade;
    ...
    private PagoProveedorFachadaLocal getFacade() {
        return ejbFacade;
    }
    ...
    public void actualizarValorPagado() {
        try {
            ejbFacade.actualizarValorPagado(selected);
    ...
    public void consultarPagos() {
        try {
            detallePagoController.setPagoProveedorSeleccionado(selected);
            detallePagoController.findByIdFactura();
        } catch (Exception e) {
            imprimirMensaje(getMessageResource(Global.ERROR_INTERNO), e);
        }
    ...
    private void persist(PersistAction persistAction, String successMessage) {
        if (selected != null) {
            ...
            try {
                ...
                if(msg.equals("Transaction marked for rollback.")){
                    imprimirMensaje(getMessageResource("noSePuedeEliminar"), FacesMessage.SEVERITY_ERROR);
                    return;
                }
                if (msg.length() > 0) {
    ...
    public PagoProveedor getPagoProveedor(java.lang.Integer id) {
    ...
    public static class PagoProveedorControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getPagoProveedor(getKey(value));
        }
