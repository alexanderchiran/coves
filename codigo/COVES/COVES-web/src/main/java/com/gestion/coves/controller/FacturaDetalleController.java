...
@SessionScoped
public class FacturaDetalleController extends Control implements Serializable {

    @Inject
    private FacturaDetalleFachadaLocal ejbFacade;
    ...
    private FacturaDetalleFachadaLocal getFacade() {
        return ejbFacade;
    }
    ...
    void findByIdFactura() {
        try {
            if (facturaSeleccionada == null) {
                ...
                items = ejbFacade.findByIdFactura(facturaSeleccionada.getIdFactura());
            }
        } catch (Exception e) {
    ...
    /**
     * @return the facturaSeleccionada
     */
    ...
    /**
     * @param facturaSeleccionada the facturaSeleccionada to set
     */
