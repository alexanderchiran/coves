...
import com.gestion.coves.fachada.MenuRolFachadaLocal;
...
public class MenuRolController implements Serializable {
    ...
    @Inject
    private MenuRolFachadaLocal ejbFacade;
    ...
    private MenuRolFachadaLocal getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        ...
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("MenuRolCreated"));
    ...
    public void update() {
        ...
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("MenuRolUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("MenuRolDeleted"));
        if (!JsfUtil.isValidationFailed()) {
